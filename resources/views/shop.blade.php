									...
									<div class="product product-widget-style">
										<div class="thumbnnail">
											<a href="{{route('details',$popular_product->id)}}" title="{{$popular_product->name_en}}">
												<figure><img src="{{asset($popular_product->main_image)}}" alt="{{$popular_product->name_en}}"></figure>
											</a>
										</div>
										<div class="product-info">
											<a href="{{route('details',$popular_product->id)}}" class="product-name">
												<span>{{$popular_product->name_en}}</span>
